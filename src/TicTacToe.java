	...
	public Player getWinner() {
		...
		int sumDiag2 = 0;
		 for (int i=0; i < board.getN(); i++) {
			...
			if (sumRow == board.getN()*player1.getValue())
				return player1;
			else if (sumRow == board.getN()*player2.getValue())
				return player2;
			else if (sumCol== board.getN()*player1.getValue())
				return player1;
			else if (sumCol == board.getN()*player2.getValue())
				return player2;
			else if (sumDiag1== board.getN()*player1.getValue())
				return player1;
			else if (sumDiag1== board.getN()*player2.getValue())
				return player2;
			else if (sumDiag1 == board.getN()*player1.getValue())
				return player2;
			else if (sumDiag2 == board.getN()*player2.getValue())
				return player2;
